...
export class Button {
  ...
  constructor(r: ElementRef) {
    inputs(this, r, [color, mode, buttonType, disabled, expand, fill, routerDirection, href, shape, size, strong, type]);
...
export class Img {
  ...
  constructor(r: ElementRef) {
    inputs(this, r, [alt, src]);
    outputs(this, [ionImgDidLoad]);
  }
}
...
export class Item {
  constructor(r: ElementRef) {
    inputs(this, r, [color, mode, button, detail, disabled, href, lines, routerDirection]);
  }
}
...
export class ItemOptions {
  ...
  constructor(r: ElementRef) {
    methods(this, r, [isEndSide, width, fireSwipeEvent]);
    inputs(this, r, [side]);
...
export class Range {
  ...
  ionBlur: EventEmitter<any>;
  constructor(r: ElementRef) {
    inputs(this, r, [color, mode, debounce, name, dualKnobs, min, max, pin, snaps, step, disabled, value]);
